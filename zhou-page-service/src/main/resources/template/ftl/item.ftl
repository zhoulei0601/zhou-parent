...
<body ng-app="zhou" ng-controller="itemController" ng-init="num = 1;loadSku()">
	<#include "head.ftl">
	<#--图片列表-->
...
购热销商品</em>
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationItemsList as specItem>
							<dl>
								<dt>
									<div class="fl title">
								...
								<#list specItem.attributeValue as specItemValue>
								<#--class="selected"-->
									<dd><a href="javascript:;" class="{{isSelected('${specItem.attributeName}','${specItemValue}') == true ? 'selected' : ''}}"
										   ng-click="selectSpec('${specItem.attributeName}','${specItemValue}')">${specItemValue} <span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
							</#list>
						</div>

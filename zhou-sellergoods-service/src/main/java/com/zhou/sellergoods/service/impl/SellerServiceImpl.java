...
import com.zhou.mapper.TbSellerMapper;
import com.zhou.pojo.TbSeller;
import com.zhou.pojo.TbSellerExample;
import com.zhou.pojo.TbSellerExample.Criteria;
...
public class SellerServiceImpl implements SellerService {
	...
	public void add(TbSeller seller) {
		seller.setStatus("0");//状态 0-未审核 1-已审核 2-审核未通过 3-关闭
